...
pipeline {
    ...
    stages {
        ...
        stage('Pre-Build') {
            ...
            steps {
                script {
                    ...
                    env['url_docker'] = "758526784474.dkr.ecr.us-east-1.amazonaws.com/base-playwright-js-qa${newVersion}"
                }
            ...
            steps {
                script {
                    ...
                    docker.withRegistry("${env.ECR_URL}",'ecr:us-east-1:ecr-private-registry'){
                        def app = docker.build("base-playwright-js-qa")
        ...
        stage ('delete image'){
            ...
            steps{
                script{
                    removeImage('base-playwright-js-qa',env['newVersion'])
                }
            }
        }
...
def notifyBuild(String buildStatus = 'STARTED') {
    ...
    if (buildStatus == 'STARTED') {
        ...
        field.put('value', 'base-playwright-js-qa');
        fields.add(field);
